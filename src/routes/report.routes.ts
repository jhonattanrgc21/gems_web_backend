...
routes.get('/', [checkJwt], ReportController.getAllUser);

// Obtener un la lista de valores previos a la insercion del registro
routes.get('/listForm', [checkJwt], ReportController.listForm);
